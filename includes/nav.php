    ...
    navLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            if (href.includes('#')) {
                ...
                // If we're on the same page (index.php or just the hash)
                if (path === '' || path === 'index.php' || path === '/index.php' || window.location.pathname.endsWith('index.php') || window.location.pathname === '/') {
                    e.preventDefault();
